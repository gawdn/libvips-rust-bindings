...
pub fn jxlload_with_opts(filename: &str, jxlload_options: &JxlloadOptions) -> Result<VipsImage> {
    unsafe {
        ...
        let page_in: i32 = jxlload_options.page;
        let page_in_name = utils::new_c_string("page")?;

        let n_in: i32 = jxlload_options.n;
        let n_in_name = utils::new_c_string("n")?;
...
pub fn jxlload_buffer_with_opts(
    ...
    unsafe {
        ...
        let page_in: i32 = jxlload_buffer_options.page;
        let page_in_name = utils::new_c_string("page")?;

        let n_in: i32 = jxlload_buffer_options.n;
        let n_in_name = utils::new_c_string("n")?;
...
pub fn jxlload_source_with_opts(
    ...
    unsafe {
        ...
        let page_in: i32 = jxlload_source_options.page;
        let page_in_name = utils::new_c_string("page")?;

        let n_in: i32 = jxlload_source_options.n;
        let n_in_name = utils::new_c_string("n")?;
